// Normalize the generated 4x4 natural giant-kelp component sheet into one
// coherent runtime atlas. Every part is cropped independently, downsampled with
...
const SRC = "art/luminous-kelp-atlas-v5-transparent.png";
const OUT = "art/luminous-kelp-atlas-v5-256.png";
const OUT_META = "art/luminous-kelp-atlas-v5-256.json";
...
writeFileSync(
  ...
  `// GENERATED by tools/gen-luminous-kelp-atlas.ts - do not edit by hand.\n` +
    `// One coherent giant-kelp species: articulated broad-bladed stems, crowns, tendrils, and amber pods.\n` +
